...
(after! ivy
  (define-key ivy-minibuffer-map (kbd "C-t") 'ivy-restrict-to-matches)
  )

(map!
 (:leader
  (:desc "Search current buffer"  :n  "/" #'+default/search-project)
  (:desc "Fly Check Errors" :prefix "e"
 ...
 (:prefix ","
  (:prefix "g"
    (:desc "goto definition "  :n  "g" #'+lookup/definition)
    (:desc "goto definition "  :n  "a" #'projectile-find-other-file)
   )
  )
 )
