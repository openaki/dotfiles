...
require('telescope').setup {
  ...
  pickers = {
    find_files = {
      find_command = {"fd", "--hidden", "--exclude", ".git",  "--type", "file", "-L"}
    },
  },
}
...
vim.keymap.set('n', '<leader>o', require('telescope.builtin').resume)
...
local on_attach = function(_, bufnr)
  ...
  vim.keymap.set('n', '<leader>co', require('telescope.builtin').lsp_document_symbols, opts)
  -- vim.api.nvim_create_user_command("Format", vim.lsp.buf.range_formatting, opts)
end
...
-- A.vim polluting insert mappings
